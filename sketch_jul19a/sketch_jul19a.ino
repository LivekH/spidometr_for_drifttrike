...
void drawGui() {
  ...
  gfx->fillArc(106, 120, 100, 90, 0, 360, 0x001F);

  // внешняя окантовка
  gfx->drawCircle(106, 120, 104, 0x4D5E);

  // Шкала спидометра 0…40
  gfx->fillArc(106, 120, 76, 74, 150, 30, 0xCE9B);
  ...
  gfx->fillArc(239, 120, 74, 59, 232, 128, 0x001F);

  // белая окантовка второго прибора
  gfx->fillArc(239, 120, 80, 79, 232, 128, 0xFFFF);

  // красный / жёлтый / зелёный сектор вольтметра
  gfx->fillArc(239, 120, 63, 57, 235, 270, 0xF800);
  gfx->fillArc(239, 120, 63, 57, 270, 305, 0xFFE0);
  gfx->fillArc(239, 120, 63, 57, 305, 340, 0x07E0);

  // Шкала вольтметра
  gfx->fillArc(239, 120, 59, 57, 239, 337, 0xCE9B);
  ...
  gfx->fillArc(239, 120, 63, 57, 90, 125, 0x07E0);
  gfx->fillArc(239, 120, 63, 57, 55, 90, 0xFFE0);
  gfx->fillArc(239, 120, 63, 57, 20, 55, 0xF800);

  // Шкала положения ручки газа
  gfx->fillArc(239, 120, 59, 57, 23, 121, 0xCE9B);
  ...
  gfx->fillArc(106, 120, 91, 90, 53, 125, 0xFFFF);
